  ...
  return (
    <div style={{ padding: 40, maxWidth: 900, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
        <div>
          <h1 style={{ color: T.text, margin: 0, fontSize: 28 }}>🛡️ RepoGuardian</h1>
          <p style={{ color: T.textDim, margin: "4px 0 0" }}>Autonomous AI Code Repository Manager</p>
        </div>
      </div>

      {loading && <div style={{ color: T.textDim }}>Loading repositories...</div>}

      {!loading && repos.length === 0 && (
        <div style={{
          background: T.surface, borderRadius: 16, padding: 40,
          ...
          >
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <span style={{
                  background: repo.is_active ? "#166534" : T.border,
                  color: repo.is_active ? "#86efac" : T.textMuted,
